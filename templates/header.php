  ...
  <div id="slider1" class="carousel slide" data-ride="carousel" data-wrap="true">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="d-block w-100 header-slide" alt="First slide"></div>
      </div>

      <div class="carousel-item">
        <div class="d-block w-100 header-slide" alt="Second slide"></div>
      </div>

      <div class="carousel-item">
        <div class="d-block w-100 header-slide" alt="Third slide"></div>
      </div>
    </div>
